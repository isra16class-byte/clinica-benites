...
- [x] ~~**Botón "Cancelar" → "Atrás" en las pantallas de Editar**~~ — resuelto, ver sección 8.3 para el detalle. **Pendiente confirmar en el entorno real.**
...
**Pendiente confirmar en el entorno real**: que el botón se vea y navegue correctamente en las 7 pantallas de Editar (este cambio se escribió sin acceso a PHP/Sail, como otros de sesiones anteriores).
