...
Última actualización: 24 de agosto de 2026 — novena entrada del día (el módulo de **Medicamentos e Insumos** (sección 6.3), construido en la entrada anterior, quedó **confirmado funcionando por el usuario en el entorno real**: catálogo, lotes con vencimiento, movimientos de entrada/salida con stock recalculado en vivo, protección contra borrado y permisos por rol, todo probado en vivo sin problemas.)
